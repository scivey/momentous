...
(function() {
  ...
  manipulators = (function() {
    var add, addBy, adders, sub, subBy, subbers, _addBy, _outs, _subBy, _uA, _uS, _unpartialedAdders, _unpartialedSubtracters;
    _outs = {};
    _unpartialedAdders = {};
    ...
    */
    ...
    _uA.years = function(targetMoment, years) {
    ...
    */
    ...
    _uA.days = function(targetMoment, days) {
    ...
    */
    ...
    _uA.months = function(targetMoment, months) {
    ...
    */
    ...
    _uA.hours = function(targetMoment, hours) {
    ...
    */
    ...
    _uA.minutes = function(targetMoment, minutes) {
    ...
    */
    ...
    _uA.seconds = function(targetMoment, seconds) {
    ...
    */
    ...
    _uA.msec = function(targetMoment, millisecs) {
    ...
    */
    ...
    _uA.lit = function(targetMoment, objectLiteral) {
    ...
    */
    ...
    _uS.years = function(targetMoment, years) {
    ...
    */
    ...
    _uS.days = function(targetMoment, days) {
    ...
    */
    ...
    _uS.months = function(targetMoment, months) {
    ...
    */
    ...
    _uS.hours = function(targetMoment, hours) {
    ...
    */
    ...
    _uS.minutes = function(targetMoment, minutes) {
    ...
    */
    ...
    _uS.seconds = function(targetMoment, seconds) {
    ...
    */
    ...
    _uS.msec = function(targetMoment, millisecs) {
    ...
    */
    ...
    _uS.lit = function(targetMoment, objectLiteral) {
