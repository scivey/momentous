...
fs.readFile indir("../mdsrc/intro.md"), "utf8", (err, res) ->
	marked res, (err, html) ->
		...
		stache.render "straight", {linkName: "Home", projectTitle: "inmedia", pageContents: html, windowTitle: windowTitle, title: title}, (err, rendered) ->
...
fs.readFile indir("../mdsrc/overview.md"), "utf8", (err, res) ->
	marked res, (err, html) ->
		...
		if title?
			windowtitle = title + " | " + windowTitle
		stache.render "straight", {linkName: "Overview", projectTitle: "inmedia", pageContents: html, windowTitle: windowTitle, title: title}, (err, rendered) ->
